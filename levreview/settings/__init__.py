"""
Django settings for levreview project.
...
MIDDLEWARE = [
    ...
    "levreview.middleware.CanonicalHostRedirectMiddleware",
...
WSGI_APPLICATION = "levreview.wsgi.application"
